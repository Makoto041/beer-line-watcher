  ...
  return (
    <div className="max-w-xl mx-auto mt-5 md:mt-8">
      <a
        ...
        className="flex items-center justify-between gap-3 px-4 py-3 md:px-5 md:py-3.5 card hover:border-[#06C755] transition-all group"
      >
        <div className="flex items-center gap-3">
          ...
          {/* Content */}
          <div>
            <p className="text-sm md:text-base text-[var(--text-primary)] font-semibold">
              新着イベントをLINEでお届け
            </p>
        ...
        {/* Arrow */}
        <div className="flex-shrink-0 text-[var(--text-muted)] group-hover:text-[#06C755] transition-colors">
...
export function LineBotFooterLink() {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="inline-flex items-center gap-2 px-4 py-2 bg-[#06C755] hover:bg-[#05B34C] text-white text-xs md:text-sm font-semibold rounded-lg transition-all hover:scale-105"
    >
